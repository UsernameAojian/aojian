			...
			<div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">角色</span> <select
						class="form-control" name="txt_search_roleid"
						id="txt_search_roleid">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table
							...
							<tr>
								<td>人员特点：</td>
								<td><input type="checkbox" id="expressTrait"
									name="expressTrait" aria-required="true" required value="干练" />干练
									<input type="checkbox" id="expressTrait" name="expressTrait"
									aria-required="true" required value="耐心" />耐心 <input
									type="checkbox" id="expressTrait" name="expressTrait"
									aria-required="true" required value="效率" />效率</td>
								<td>&nbsp;&nbsp;</td>
							</tr>
							<tr>
								<td>入职时间：</td>
							...
							<tr>
								...
								<td colspan="4"><select class="form-control"
									name="expressTypeId" id="expressTypeId" aria-required="true"
									required>
										<option value="">---请选择---</option>
...
<!-- 	饼图 -->
	<div class="modal fade" id="modal_user_bing" role="dialog" aria-labelledby="modal_user_bing" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body" id="bingbing" style="width: 600px;height: 300px">
...
<!-- 	折线图 -->
	<div class="modal fade" id="modal_user_xian" role="dialog" aria-labelledby="modal_user_xian" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body" id="xianxian" style="width: 600px;height: 300px">
	...
	<!-- 	柱状图 -->
	<div class="modal fade" id="modal_user_zhu" role="dialog" aria-labelledby="modal_user_zhu" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-boby" id="zhuzhu"
	...
	<script type="text/javascript">
		...
		var ButtonInit = function() {
			...
			$("#btn_bing").click(function() {	
				...
				var myEcharts = echarts.init(document.getElementById("bingbing"));
				var num = new Array();
				var name = new Array();
				var dxsz = new Array();
				$.ajax({
				...
				$("#modal_user_bing").show();
			});
			
// 			折线图
			$("#btn_xian").click(function() {
				var myEcharts = echarts.init(document.getElementById("xianxian"));
				$('#modal_user_xian').modal({backdrop : 'static',keyboard : false  });
				var num = new Array();
				var name = new Array();
				$.ajax({
					url : "getEcharts.htm",
				...
				$("#modal_user_xian").show();
			});

			
// 			柱状图
			$("#btn_zhu").click(function() {
				var myEcharts = echarts.init(document.getElementById("zhuzhu"));
		...
		function initEditUser(getSelection) {
			...
			for (var i = 0; i < sz.length; i++) {
				$("input[value='" + sz[i] + "']").attr("checked", true);
			}
			$('#entryTime').val(
