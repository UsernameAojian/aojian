        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">员工称号</span>
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="did" id = "txt_search_dname">
					...
					<form id="form_user" method="post" action="reserveEmp.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>员工特点：</td>
								<td>
									<input type="checkbox" id="tedian" name="tedian" value="耐心"/>耐心
									<input type="checkbox" id="tedian" name="tedian" value="干练"/>干练
									<input type="checkbox" id="tedian" name="tedian" value="好看"/>好看
								</td>
								<td>&nbsp;&nbsp;</td>
							</tr>
							<tr>
								<td>员工头像：</td>
								<td>
									<img alt="" src="" id="pics" width="40px" height="40px">
	           ...
	           // height: 500,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
	            ...
	            },
	            {
	                ...
	                formatter:function(value,row,index){
	                	return "<img src='/photo/"+value+"' width='40px' height='40px'>";
	                }
	            },
	            {
	                field: 'birthday',
