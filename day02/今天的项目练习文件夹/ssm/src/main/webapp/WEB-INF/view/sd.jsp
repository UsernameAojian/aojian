...
<body class="gray-bg">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="caozuoSd.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>学生性别：</td>
								<td colspan="4">
									<select class="form-control" name="sdex" id ="sdex" aria-required="true" required>
							...
							<tr>
								<td>学生爱好：</td>
								<td>
									<input type="checkbox" id=sdhobby name="sdhobby" value="滑板"/>滑板
									<input type="checkbox" id=sdhobby name="sdhobby" value="篮球"/>篮球
									<input type="checkbox" id=sdhobby name="sdhobby" value="乒乓球"/>乒乓球
									<input type="checkbox" id=sdhobby name="sdhobby" value="羽毛球"/>羽毛球
								</td>
								<td>&nbsp;&nbsp;</td>
							</tr>
							<tr>
								<td>学生生日：</td>
								<td><input type="date" id="sdbirthday" name="sdbirthday"
									class="form-control" aria-required="true" required/></td>
								<td>&nbsp;&nbsp;</td>
							</tr>
							<tr>
	...
	function initEditUser(getSelection){
		...
		$('#sdex').val(getSelection.sdex);
		$('#sdbirthday').val(new Date(getSelection.sdbirthday).Format('yyyy-MM-dd'));
