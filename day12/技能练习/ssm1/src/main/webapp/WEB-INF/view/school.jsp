...
<body class="gray-bg">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveSchool.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>分校状态：</td>
								<td><input type="radio" id="status" name="status" aria-required="true" required value="倒闭"/>倒闭
								<input type="radio" id="status" name="status" aria-required="true" required value="营业"/>营业</td>
								<td>&nbsp;&nbsp;</td>
							</tr>
	...
	$("#btn_export").click(function(){
		location.href="${path}/school/exportExcel.htm"
	});
