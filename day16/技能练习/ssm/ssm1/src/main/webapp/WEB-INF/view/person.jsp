					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>人员爱好：</td>
								<td>
									<input type="checkbox" id="pLike" name="pLike" aria-required="true" required value="足球"/>足球
									<input type="checkbox" id="pLike" name="pLike" aria-required="true" required value="滑板"/>滑板
									<input type="checkbox" id="pLike" name="pLike" aria-required="true" required value="篮球"/>篮球
								</td>
								<td>&nbsp;&nbsp;</td>
							</tr>
							<tr>
