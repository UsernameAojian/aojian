		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveStudnet.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>学生生日：</td>
								<td><input type="date" id="birthday" name="birthday" aria-required="true" required/></td>
								<td>&nbsp;&nbsp;</td>
							</tr>
							<tr>
								<td>学生年龄：</td>
								<td><input type="text" id="age" name="age" aria-required="true"/> </td>
								<td>&nbsp;&nbsp;</td>
							</tr>
							<tr>
								<td>学生性别：</td>
								<td><input type="radio" id="sex" name="sex" aria-required="true" required value="男"/>男
								<input type="radio" id="sex" name="sex" aria-required="true" required value="女"/>女</td>
								<td>&nbsp;&nbsp;</td>
							</tr>
							<tr>
								<td>学生学校：</td>
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
							<form id="form_import" action="importExcel.htm" enctype="Multipart/form-data" method="post">
...
// 	    		$('#password').attr("readOnly",false).val(getSelection.password);
	...
	$("#btn_export").click(function(){
		location.href="${path}/student/export.htm"
	});
