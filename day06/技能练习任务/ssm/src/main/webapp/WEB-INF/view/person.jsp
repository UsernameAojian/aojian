					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>人员特点：</td>
								<td>
									<input type="checkbox" id="expressTrait" name="expressTrait" aria-required="true" required value="干练"/>干练
									<input type="checkbox" id="expressTrait" name="expressTrait" aria-required="true" required value="耐心"/>耐心
									<input type="checkbox" id="expressTrait" name="expressTrait" aria-required="true" required value="效率"/>效率
								</td>
								<td>&nbsp;&nbsp;</td>
							</tr>
							<tr>
