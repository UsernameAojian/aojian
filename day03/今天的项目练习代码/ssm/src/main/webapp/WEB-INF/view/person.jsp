        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="expressName" class="form-control" id="txt_search_express_name" >
				</div>
			  </div>
<!-- 			  <div class="col-lg-2"> -->
<!-- 				<div class="input-group"> -->
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>
									...
									<input type="checkbox" id="expressTrait" name="expressTrait" value="热情"/>热情
								...
								<td colspan="4">
									<select class="form-control" name="expressTypeId" id="expressTypeId" aria-required="true" required>
										...
										<c:forEach items="${cList}" var="c">
										 	<option value="${c.id }">${c.expressName1 }</option>
										</c:forEach>
				                	</select>
								</td>
								<td>&nbsp;&nbsp;</td>
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            username: $("#txt_search_express_name").val(),
...
// 		$("input[value="+getSelection.sex+"]").prop("checked",true);
	...
	/* $("#btn_export").click(function(){
		location.href="${path}/person/export.htm";
	});  */
	$("#btn_export").click(function(){
		$.ajax({
		    url:"exp.htm",
